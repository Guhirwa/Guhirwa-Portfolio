  ...
  return (
    <div className='xl:e-[20%] lg:w-[30%] border border-light-brown p-4 rounded-xl'>
        <p className='text-lg text-center text-light-grey'>
            ...
            from small bussiness websites to <span className='font-bold text-white'>complex front-end systems</span>, always aiming forclean code 
...
export default ExperienceTopRigth
